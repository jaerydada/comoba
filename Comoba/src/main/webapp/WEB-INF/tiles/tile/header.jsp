                       ...
                       <!--공스토리-->
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="/main/state.action">내 공부현황</a></li>
                            </ul>
                        </li>
                     	</c:if>
                        <!--송희가 한 우리방-->
                        ...
                        <!--관리자-->
                        <li class="dropdown" >
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #f5f5f5;">관리자<i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu">
