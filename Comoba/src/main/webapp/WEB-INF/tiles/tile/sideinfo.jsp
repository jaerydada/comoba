...
.sm_menu{
   ...
   background-image: url('<%= request.getContextPath() %>/resources/img/sm/stopwatch_back.png');
}
.sm_toom{
...
<div id="ajaxtest" style="z-index: 9999 !important;"></div>
...
function goGetjepumTypeCode2() {
   ...
   $.ajax({
      ...
      //   alert("아잭전:"+$("sm_count").val());
               ...
               var html = "<div ><img class='sm_show' alt='1' style='height:42.5px; width:auto;' src='<%= request.getContextPath() %>/resources/img/sm/alarm-clock5.png' ></div>";
               html += "<div class='sm_menu'  >";
               
               html += "<p id='sm_demo' style=' width:auto;'></p>";
               html += "<div style='width:222px; padding-left:37px;'><button class='sm_start sm_toom'>start</button>&nbsp;&nbsp;&nbsp;&nbsp;";
               html += "<button class='sm_stop sm_toom'>stop</button>&nbsp;&nbsp;&nbsp;&nbsp;";
               html += "<button class='sm_reset sm_toom'>reset</button></div>";
               html += "<div style='float:right;'> <img class='sm_hide' alt='1' style='height:80px; width:auto;' src='<%= request.getContextPath() %>/resources/img/sm/startstudy.png' > </div>";
            ...
            //alert("아잭후:"+auto);
               ...
               var swit = 0;
                if(sm_switch==3){
                   document.getElementById("sm_demo").innerHTML = "0h 0m 0s ";
                   swit = 3;
                }
                /*  else{
               ...
               //      alert("swit"+swit);
                 ...
                 //    alert("리셋값을 가져가"+ cnttt);
                   ...
                   if(switcht==0){ document.getElementById("sm_demo").innerHTML = "0h 0m 0s ";}
