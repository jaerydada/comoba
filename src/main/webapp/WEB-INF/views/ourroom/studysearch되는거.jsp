...
<div style="width: 100%;" id="map"></div>
	...
	<div id="floating-panel" style="margin-left:85%;  margin-top: 1%;" >
		<input id="address" type="text" value="당산" onkeydown=""> <input
	...
	<script>
        ...
        $(document).ready(function(){
        	...
        	document.getElementById("centerX").value =  126.896947;
       		document.getElementById("centerY").value = 37.533876;
	    			   ...
	    			   $.each(data, function(entryIndex, entry){
                           ...
                           if(nro%2 ==1 ) {   //홀수면
						    ...
						    result = "<div class='image-box'><img src='<%=request.getContextPath() %>/resources/files/"+title+"' alt='왜없니;;ㅋㅋㅋ' class='img-responsive'> "  
							       + " </div> </div> <div class='col-sm-12 col-md-2 text-center'> <div class='story-date'> <div class='date-only'> 2017<div class='jy'>02-12</div> </div> </div> </div>"
							       ...
							       + " <div class='jy'> 지역 : " + addr1 + addr2 +"</div><div class='jy'> 비용 : "+ cost +" 원 ( 1시간 1인)</div><div class='jy'> H.P :</div>"
							       + " "+hp +" <br/> <p> <a href='/main/story/studyroom.action' class='btn btn-theme-dark'>상세페이지 보기</a>"
							       + "</p>"; 
						
                           }
                           else {   //짝수면
                        	   
                        	   result =" <h3> <span>"+nro+".</span>  "+ studyroom_name +" </h3> <p> 이름 : " + studyroom_name
                        	          + "</h3> <p> 이름 : " + studyroom_name
                        	          + " <div class='jy'> 지역 : " + addr1 + addr2 +"</div><div class='jy'> 비용 : "+ cost +" 원 ( 1시간 1인)</div><div class='jy'> H.P :</div> "+ hp +" <br/> <p>"
                        		      + "<a href='/main/story/studyroom.action' class='btn btn-theme-dark'>상세페이지 보기</a> <p>" 
                        		      + "</div> <div class='col-sm-12 col-md-2 text-center'> <div class='story-date'> <div class='date-only'> 2017</br>02-12</br> </div> </div> </div>" 
